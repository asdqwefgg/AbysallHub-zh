...
local Translations = {
    ...
    ["Climb on a ladder to bypass the anticheat"] = "爬上梯子绕过反作弊",
    ...
    ["Your movement is now fully automated"] = "您的行动现已完全自动",
    ["Please keep looking forwards for auto minecart to work"] = "请看向前方以让自动矿车正常运作",
    ["Auto minecart has finished"] = "自动矿车已完成",
    ["You are now in control of your movement"] = "你现在可以控制你的行动了",
    ["Successfully solved anchor code"] = "成功解开锚点代码",
    ["The code for Anchor"] = "锚点代码",
    [" is "] = " 是 ",
